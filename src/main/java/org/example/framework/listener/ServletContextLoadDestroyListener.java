...
public class ServletContextLoadDestroyListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            /*
            QUESTION: У меня есть /cards, которые не зависят от users, а есть /users/{userId}/cards,
            которые зависят от users. Нормально ли получать ресурсы и так, и так, или карточки должны всегда
            браться по userId и cardId?
             */
